...
struct ResultCardView: View {
    ...
    //                    isInputMessage = false
                        sesrchViewHight = .height(Constants.sheetCollapsedHeight)
                    }
                    // 更新地图标注
//                    Task {
...
//                                // 帮他（紫色）-胶囊按钮fill
//                        isInputMessage = true
//                        resultCardCurrentDetent = .fraction(Constants.sheetExpandedFraction)
//                            }) {
//                                Text("🥺 求一下这里最新的照片或视频")
//                            }
...
#Preview {
    ResultCardView(sesrchViewHight: .constant(.height(Constants.sheetCollapsedHeight)))
