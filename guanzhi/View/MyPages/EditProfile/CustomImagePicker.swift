...
fileprivate struct CustomImagePicker<Content: View>: View {
    ...
    @State private var showIntermediate: Bool = false
...
//            .sheet(isPresented: $showIntermediate) {
//                IntermediateView(showCropView: $showCropView)
//            }
            .overlay(content: {
                if showIntermediate {
                    IntermediateView(showIntermediate: $showIntermediate, showCropView: $showCropView)
                }
            })
            .fullScreenCover(isPresented: $showCropView) {
                ...
                CropView(crop: .square, image: selectedImage) { croppedImage, status in
                    if let croppedImage {
...
struct IntermediateView: View {
    @Binding var showIntermediate: Bool
    @Binding var showCropView: Bool   // 用来触发 CropView
    var body: some View {
        ZStack {
